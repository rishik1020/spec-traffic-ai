...
*State refreshed 26 August 2026, 23:17 by `scripts/handoff.py`.*
...
```
476b4d0 Deck + review doc: adaptive signal timing, real literature review, references
b85b327 HANDOFF: refresh auto block after the signal-timing commit
27a0f3c Add adaptive signal timing: per-arm congestion -> recommended green split
