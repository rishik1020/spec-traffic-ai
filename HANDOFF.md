...
*State refreshed 26 August 2026, 20:59 by `scripts/handoff.py`.*

### Repository

- branch `main` → https://github.com/rishik1020/spec-traffic-ai.git
- **7 uncommitted change(s)**
...
de94a68 Per-lane calibration; fix wrong-way false positives
65030a2 Add HANDOFF.md: full project state, findings, constraints and next actions
03b5d90 Add Review-II talk track and Q&A notes
```
...
```
M HANDOFF.md
 M PRESENTATION_NOTES.md
 M STATUS.md
 M senti/ingest/source.py
?? results/driveindia/kolkata_annotated.jpg
?? scripts/test_stream.py
?? scripts/triage_videos.py
```
...
**`senti/`** (11 modules): `senti/calibration.py`, `senti/core/types.py`, `senti/engine.py`, `senti/evidence/buffer.py`, `senti/evidence/package.py`, `senti/ingest/source.py`, `senti/perception/detector.py`, `senti/rules/base.py`, `senti/rules/lane_discipline.py`, `senti/rules/over_speeding.py`, `senti/rules/wrong_way.py`

**`scripts/`**: `calibrate.py`, `fetch_datasets.py`, `handoff.py`, `prepare_driveindia.py`, `prune_classes.py`, `test_stream.py`, `train_colab.py`, `train_local.py`, `triage_videos.py`, `voc_to_yolo.py`

**`config/`**: `cam_demo.yaml`, `cam_orr.yaml`
